...
function insa_breadcrumb($variables) {
	global $base_url;
...
function insa_menu_tree($variables) {
...
function insa_links__system_secondary_menu(&$variables) {
    $output = '';
    $extra_classes = array(
        'user' => 'secnav_account',
...
function insa_status_messages($variables) {
